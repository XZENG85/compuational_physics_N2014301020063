...
A.calculate()
sub1.plot(A.t,A.sita,'b',label='$F_D=1.35$')
...
A.calculate()
sub2.plot(A.t,A.sita,'r',label='$F_D=1.44$')
...
A.calculate()
sub3.plot(A.t,A.sita,'b',label='$F_D=1.465$')
...
sub4=py.subplot(224)
A=pendulum0(1.49,0.2)
A.calculate()
sub4.plot(A.t,A.sita,'r',label='$F_D=1.49$')
